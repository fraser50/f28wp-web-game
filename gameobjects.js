...
class Player extends GameObject {
	constructor(pos, rotation, level, velocity, id, isGuest, team, image) {
		...
		//following fields are Position coordinates used for collision detection
		//NOTE: 0.7 is the distance from centre of bot to edge of bot sprite (According to UI coordinates)
        this.leftEdge = this.pos.x - 0.7;
        this.rightEdge = this.pos.x + 0.7;
        this.topEdge = this.pos.y - 0.7;
        this.bottomEdge = this.pos.y + 0.7;
        
        this.topLeftCorner = this.topEdge - 0.7;
        this.topRightCorner = this.topEdge + 0.7;
        this.bottomLeftCorner = this.bottomEdge - 0.7;
        this.bottomRightCorner = this.bottomEdge + 0.7;
